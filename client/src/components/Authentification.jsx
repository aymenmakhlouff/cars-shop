...
<form class="form_container">
        ...
        <div class="input_container">
          ...
          <input  onChange={(e)=>setValmail(e.target.value)} placeholder="name@mail.com" title="Inpit title" name="input-name" type="text" class="input_field" id="email_field" />
        </div>
        <div class="input_container">
          ...
          <input onChange={(e)=>setValpass(e.target.value)} placeholder="Password" title="Inpit title" name="input-name" type="password" class="input_field" id="password_field" />
        </div>
        
 <button  onClick={()=>{navigate("/home") ,props.login(valMail,valPass)}} title="Sign In" type="submit" class="sign-in_btn"  >
          <span>Sign In</span>
        </button>
        ...
        <button  onClick={()=>navigate("/signup")} title="Sign In" type="submit" class="sign-in_ggl">
          <svg height="18" width="18" viewBox="0 0 32 32"  xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg">
            <defs>
 ...
 <button   onClick={()=>props.login(valMail,valPass)}  title="Sign In" type="submit" class="sign-in_btn"  >
          <span>Sign In</span>
        </button>
